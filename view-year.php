          ...
          <div class="card">
              <h1 class="text-center bg-dark p-3 mw-100"> <span class="text-danger font-weight-bold h1 ">X</span> 
                ...
                <div class="card-header bg-primary ">
                  <h3 class="card-title text-white font-weight-bold ml-5 ">View Year</h3>
                </div>
          <!-- Content Row -->
          ...
          <form action="#" method="POST" enctype="multipart/form-data ">
            <div class="row">
                <div class="form-group col-6">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" disable aria-describedby="emailHelp" name="year" disabled value="<?php echo $data_row['year']; ?>">
                </div>
                <div class="form-group col-6">
                ...
                <a href="manage-years.php"><button type="button" class="btn btn-primary mb-4 " name="submit">View Year</button></a>
                    </div>
              </form>
